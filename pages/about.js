    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am a Front-end Developer.I like dabbling in various parts of frontend development and like to learn about new technologies, read technical articles or simply play games in my free time.
        </p>
