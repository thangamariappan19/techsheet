...
Author: Thanga
Tags: Git cheatsheet
Abstract: This is my personal git cheat sheet. This is not a deep dive into how git works, just some of the simple stuff.
HeaderImage: /BL-1004/git.jpg
isPublished: true
---

# git-cheat-sheet {#git-cheat-cheat}
...
##### Go back and checkout {#Go-back-and-checkout}
...
##### Delete everything and just start restart from chosen commit {Delete-everything-and-just-start-restart-from-chosen-commit}
1. There are no changes that have not been committed.
...
```
##### Start over from head or master {Start-over-from-head-or-master}
...
##### Correcting small mistakes {Correcting-small-mistakes}
...
##### Removed files conflict  {#Removed-files-conflict}
